    ...
    return (
        <section className={theme === "light" ? "app sliding-forecast light-forecast" : "app sliding-forecast dark-forecast"}>
            ...
            <div className = "scroll-container">
                <button onClick={() => scroll("left")} className = "scroll-button" disabled={!canScrollLeft}>◀</button>
                ...
                <button onClick={() => scroll("right")} className = "scroll-button" disabled={!canScrollRight}>▶</button>
            </div>
        </section>
    );
}
